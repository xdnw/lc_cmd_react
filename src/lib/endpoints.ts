...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, UNSET_GUILD, SET_OAUTH_CODE, INPUT_OPTIONS, LOGIN_MAIL, SET_TOKEN, SET_GUILD, TRADEPRICEBYDAYJSON, RAID, RECORDS, BALANCE, WITHDRAW, ANNOUNCEMENTS, VIEW_ANNOUNCEMENT, UNREAD_COUNT, BANK_ACCESS, MARK_ALL_READ, READ_ANNOUNCEMENT, UNPROTECTED, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, MY_AUDITS, MY_WARS, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, CONFLICTALLIANCES, GLOBALSTATS, GLOBALTIERSTATS, COMPARESTATS, ALLIANCESTATS, COMPARETIERSTATS, CITYTIERGRAPH, STRENGTHTIERGRAPH, TRADEMARGINBYDAY, TRADEPRICEBYDAY, TRADEVOLUMEBYDAY, TRADETOTALBYDAY, METRICBYGROUP, SPYTIERGRAPH, ALLIANCEMETRICBYTURN, WARSCOSTRANKINGBYDAY, METRIC_COMPARE_BY_TURN, NTHBEIGELOOTBYSCORERANGE, ALLIANCESDATABYDAY, ORBISSTATBYDAY, WARCOSTSBYDAY, WARATTACKSBYDAY, RADIATIONBYTURN, SCORETIERGRAPH, MILITARIZATIONTIME, ALLIANCEMETRICAB, COMPARESTOCKPILEVALUEBYDAY, TAX_EXPENSE, MULTI_BUSTER, MULTI_V2];
