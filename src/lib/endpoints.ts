...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, UNSET_GUILD, SET_OAUTH_CODE, INPUT_OPTIONS, LOGIN_MAIL, SET_TOKEN, SET_GUILD, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RECORDS, RAID, BALANCE, WITHDRAW, AUTOROLEALL, BANK_ACCESS, UNREAD_COUNT, UNPROTECTED, MARK_ALL_READ, READ_ANNOUNCEMENT, VIEW_ANNOUNCEMENT, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, AUTOROLE, MY_WARS, MY_AUDITS, LOCUTUS_TASKS, LOCUTUS_TASK, SETTINGS_VALIDATION_ERRORS, SETTINGS_VALIDATION_CHEAPNESS, TABLE, CONFLICTALLIANCES, VIRTUALCONFLICTS, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, CONFLICTPOSTS, GLOBALSTATS, GLOBALTIERSTATS, ALLIANCESTATS, COMPARETIERSTATS, COMPARESTATS, METRICBYGROUP, TRADEPRICEBYDAY, COMPARESTOCKPILEVALUEBYDAY, METRIC_COMPARE_BY_TURN, NTHBEIGELOOTBYSCORERANGE, ALLIANCEMETRICBYTURN, WARSCOSTRANKINGBYDAY, COMPARETIERDELTAGRAPH, SPYTIERGRAPH, CITYTIERGRAPH, ALLIANCEMETRICAB, ORBISSTATBYDAY, RADIATIONBYTURN, ALLIANCESDATABYDAY, TRADEVOLUMEBYDAY, TRADETOTALBYDAY, WARATTACKSBYDAY, STRENGTHTIERGRAPH, MILITARIZATIONTIME, TRADEMARGINBYDAY, SCORETIERGRAPH, WARCOSTSBYDAY, TAX_EXPENSE_BRACKET_ROWS, TAX_EXPENSE_BY_TIME, TAX_EXPENSE_NATION, TAX_EXPENSE, TAX_EXPENSE_BY_TIME_RESOURCES, TAX_EXPENSE_BY_TIME_BRACKET, LIST_COALITIONS, LIST_AUTOROLE_ROLES, REMOVE_ALLIANCE_ROLE, ADD_CITY_ROLE, ADD_TAX_ROLE, REMOVE_CITY_ROLE, LIST_ROLE_ALIASES, REMOVE_TAX_ROLE, ADD_ALLIANCE_ROLE, MULTI_BUSTER, MULTI_V2, CURRENT_TREATIES, TREATY_CHANGES];
