...
export const TAX_EXPENSE_BY_TIME_RESOURCES: CommonEndpoint<ApiTypes.TaxExpenseTimeResources, {start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}, {start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}> = {
    endpoint: new ApiEndpoint<ApiTypes.TaxExpenseTimeResources>(
        "tax_expense_by_time_resources",
        "tax_expense_by_time_resources",
        {"start":{"name":"start","type":"long[Timestamp]"},"end":{"name":"end","type":"long[Timestamp]"},"nationFilter":{"name":"nationFilter","optional":true,"type":"Set\u003cDBNation\u003e"},"dontRequireTagged":{"name":"dontRequireTagged","optional":true,"flag":"t","type":"boolean"}},
        (data: unknown) => data as ApiTypes.TaxExpenseTimeResources,
        2592000,
        'None',
        "TaxExpenseTimeResources",
        `Get total tax expense series by resource over time`,
        false
    )
};

export const TAX_EXPENSE_BRACKET_MEMBERS: CommonEndpoint<ApiTypes.TaxExpenseBracketMembers, {start?: string, end?: string, taxId?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}, {start?: string, end?: string, taxId?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}> = {
    endpoint: new ApiEndpoint<ApiTypes.TaxExpenseBracketMembers>(
        "tax_expense_bracket_members",
        "tax_expense_bracket_members",
        {"start":{"name":"start","type":"long[Timestamp]"},"end":{"name":"end","type":"long[Timestamp]"},"taxId":{"name":"taxId","type":"int"},"nationList":{"name":"nationList","optional":true,"flag":"n","type":"Set\u003cDBNation\u003e"},"dontRequireGrant":{"name":"dontRequireGrant","optional":true,"flag":"g","type":"boolean"},"dontRequireTagged":{"name":"dontRequireTagged","optional":true,"flag":"t","type":"boolean"},"dontRequireExpiry":{"name":"dontRequireExpiry","optional":true,"flag":"e","type":"boolean"},"includeDeposits":{"name":"includeDeposits","optional":true,"flag":"d","type":"boolean"}},
        (data: unknown) => data as ApiTypes.TaxExpenseBracketMembers,
        2592000,
        'None',
        "TaxExpenseBracketMembers",
        `List nation ids for a tax expense section`,
        false
    )
};

export const TAX_EXPENSE_NATION_TRANSACTIONS: CommonEndpoint<ApiTypes.TaxExpenseTransactions, {start?: string, end?: string, taxId?: string, nation?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}, {start?: string, end?: string, taxId?: string, nation?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}> = {
    endpoint: new ApiEndpoint<ApiTypes.TaxExpenseTransactions>(
        "tax_expense_nation_transactions",
        "tax_expense_nation_transactions",
        {"start":{"name":"start","type":"long[Timestamp]"},"end":{"name":"end","type":"long[Timestamp]"},"taxId":{"name":"taxId","type":"int"},"nation":{"name":"nation","type":"DBNation"},"nationList":{"name":"nationList","optional":true,"flag":"n","type":"Set\u003cDBNation\u003e"},"dontRequireGrant":{"name":"dontRequireGrant","optional":true,"flag":"g","type":"boolean"},"dontRequireTagged":{"name":"dontRequireTagged","optional":true,"flag":"t","type":"boolean"},"dontRequireExpiry":{"name":"dontRequireExpiry","optional":true,"flag":"e","type":"boolean"},"includeDeposits":{"name":"includeDeposits","optional":true,"flag":"d","type":"boolean"}},
        (data: unknown) => data as ApiTypes.TaxExpenseTransactions,
        2592000,
        'None',
        "TaxExpenseTransactions",
        `Get transaction rows for a nation within a tax expense section`,
        false
    )
};

export const TAX_EXPENSE_BY_TIME: CommonEndpoint<ApiTypes.TaxExpenseTime, {start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}, {start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}> = {
...
export const TAX_EXPENSE_NATION_DETAIL: CommonEndpoint<ApiTypes.TaxExpenseNationDetail, {start?: string, end?: string, taxId?: string, nation?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}, {start?: string, end?: string, taxId?: string, nation?: string, nationList?: string, dontRequireGrant?: string, dontRequireTagged?: string, dontRequireExpiry?: string, includeDeposits?: string}> = {
    endpoint: new ApiEndpoint<ApiTypes.TaxExpenseNationDetail>(
        "tax_expense_nation_detail",
        "tax_expense_nation_detail",
        {"start":{"name":"start","type":"long[Timestamp]"},"end":{"name":"end","type":"long[Timestamp]"},"taxId":{"name":"taxId","type":"int"},"nation":{"name":"nation","type":"DBNation"},"nationList":{"name":"nationList","optional":true,"flag":"n","type":"Set\u003cDBNation\u003e"},"dontRequireGrant":{"name":"dontRequireGrant","optional":true,"flag":"g","type":"boolean"},"dontRequireTagged":{"name":"dontRequireTagged","optional":true,"flag":"t","type":"boolean"},"dontRequireExpiry":{"name":"dontRequireExpiry","optional":true,"flag":"e","type":"boolean"},"includeDeposits":{"name":"includeDeposits","optional":true,"flag":"d","type":"boolean"}},
        (data: unknown) => data as ApiTypes.TaxExpenseNationDetail,
        2592000,
        'None',
        "TaxExpenseNationDetail",
        `Get detail data for a nation row within a tax expense section`,
        false
    )
};
...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, INPUT_OPTIONS, UNSET_GUILD, SET_OAUTH_CODE, SET_TOKEN, SET_GUILD, LOGIN_MAIL, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, WITHDRAW, BALANCE, RECORDS, RAID, AUTOROLEALL, READ_ANNOUNCEMENT, UNPROTECTED, BANK_ACCESS, VIEW_ANNOUNCEMENT, UNREAD_COUNT, MARK_ALL_READ, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, MY_WARS, MY_AUDITS, AUTOROLE, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, CONFLICTALLIANCES, CONFLICTPOSTS, VIRTUALCONFLICTS, VIRTUALCONFLICTINFO, REMOVEVIRTUALCONFLICT, GLOBALSTATS, GLOBALTIERSTATS, COMPARESTATS, COMPARETIERSTATS, ALLIANCESTATS, METRICBYGROUP, TRADEPRICEBYDAY, SPYTIERGRAPH, TRADEVOLUMEBYDAY, TRADETOTALBYDAY, STRENGTHTIERGRAPH, WARATTACKSBYDAY, MILITARIZATIONTIME, ALLIANCESDATABYDAY, TRADEMARGINBYDAY, CITYTIERGRAPH, WARCOSTSBYDAY, SCORETIERGRAPH, ORBISSTATBYDAY, ALLIANCEMETRICAB, RADIATIONBYTURN, NTHBEIGELOOTBYSCORERANGE, COMPARETIERDELTAGRAPH, METRIC_COMPARE_BY_TURN, ALLIANCEMETRICBYTURN, COMPARESTOCKPILEVALUEBYDAY, WARSCOSTRANKINGBYDAY, TAX_EXPENSE, TAX_EXPENSE_BY_TIME_RESOURCES, TAX_EXPENSE_BRACKET_MEMBERS, TAX_EXPENSE_NATION_TRANSACTIONS, TAX_EXPENSE_BY_TIME, TAX_EXPENSE_NATION_DETAIL, LIST_COALITIONS, LIST_AUTOROLE_ROLES, REMOVE_ALLIANCE_ROLE, ADD_TAX_ROLE, REMOVE_CITY_ROLE, ADD_ALLIANCE_ROLE, ADD_CITY_ROLE, REMOVE_TAX_ROLE, LIST_ROLE_ALIASES, MULTI_V2, MULTI_BUSTER, CURRENT_TREATIES, TREATY_CHANGES];
