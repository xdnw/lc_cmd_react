...
export const ENDPOINTS = [LOGOUT, LOGIN_MAIL, UNSET_GUILD, INPUT_OPTIONS, SET_OAUTH_CODE, SET_GUILD, SET_TOKEN, REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RECORDS, RAID, WITHDRAW, BALANCE, READ_ANNOUNCEMENT, BANK_ACCESS, VIEW_ANNOUNCEMENT, UNREAD_COUNT, UNPROTECTED, MARK_ALL_READ, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, MY_AUDITS, MY_WARS, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, CONFLICTALLIANCES, GLOBALSTATS, GLOBALTIERSTATS, COMPARETIERSTATS, METRICBYGROUP, COMPARESTATS, TRADEPRICEBYDAY, NTHBEIGELOOTBYSCORERANGE, METRIC_COMPARE_BY_TURN, ALLIANCEMETRICBYTURN, COMPARESTOCKPILEVALUEBYDAY, WARSCOSTRANKINGBYDAY, ORBISSTATBYDAY, STRENGTHTIERGRAPH, TRADETOTALBYDAY, RADIATIONBYTURN, ALLIANCEMETRICAB, WARCOSTSBYDAY, TRADEMARGINBYDAY, WARATTACKSBYDAY, TRADEVOLUMEBYDAY, SCORETIERGRAPH, SPYTIERGRAPH, ALLIANCESDATABYDAY, MILITARIZATIONTIME, CITYTIERGRAPH, ALLIANCESTATS, TAX_EXPENSE, MULTI_V2, MULTI_BUSTER];
