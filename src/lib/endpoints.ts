...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, UNSET_GUILD, INPUT_OPTIONS, SET_OAUTH_CODE, SET_GUILD, SET_TOKEN, LOGIN_MAIL, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RAID, BALANCE, WITHDRAW, RECORDS, AUTOROLEALL, BANK_ACCESS, UNPROTECTED, READ_ANNOUNCEMENT, MARK_ALL_READ, VIEW_ANNOUNCEMENT, UNREAD_COUNT, AUTOROLE, MY_WARS, MY_AUDITS, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, CONFLICTALLIANCES, VIRTUALCONFLICTS, CONFLICTPOSTS, VIRTUALCONFLICTINFO, REMOVEVIRTUALCONFLICT, GLOBALSTATS, GLOBALTIERSTATS, ALLIANCESTATS, COMPARETIERSTATS, COMPARESTATS, METRICBYGROUP, TRADEPRICEBYDAY, MILITARIZATIONTIME, ALLIANCESDATABYDAY, RADIATIONBYTURN, WARCOSTSBYDAY, CITYTIERGRAPH, ALLIANCEMETRICAB, TRADEMARGINBYDAY, SCORETIERGRAPH, WARATTACKSBYDAY, SPYTIERGRAPH, TRADETOTALBYDAY, STRENGTHTIERGRAPH, TRADEVOLUMEBYDAY, ORBISSTATBYDAY, COMPARETIERDELTAGRAPH, COMPARESTOCKPILEVALUEBYDAY, ALLIANCEMETRICBYTURN, WARSCOSTRANKINGBYDAY, METRIC_COMPARE_BY_TURN, NTHBEIGELOOTBYSCORERANGE, TAX_EXPENSE_BY_TIME_BRACKET, TAX_EXPENSE_BY_TIME_RESOURCES, TAX_EXPENSE, TAX_EXPENSE_NATION, TAX_EXPENSE_BY_TIME, TAX_EXPENSE_BRACKET_ROWS, LIST_COALITIONS, REMOVE_CITY_ROLE, REMOVE_TAX_ROLE, ADD_TAX_ROLE, ADD_ALLIANCE_ROLE, LIST_ROLE_ALIASES, ADD_CITY_ROLE, LIST_AUTOROLE_ROLES, REMOVE_ALLIANCE_ROLE, MULTI_V2, MULTI_BUSTER, TREATY_CHANGES, CURRENT_TREATIES];
