...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, LOGIN_MAIL, INPUT_OPTIONS, SET_OAUTH_CODE, UNSET_GUILD, SET_GUILD, SET_TOKEN, TRADEPRICEBYDAYJSON, RAID, RECORDS, WITHDRAW, ANNOUNCEMENTS, BALANCE, UNPROTECTED, UNREAD_ANNOUNCEMENT, ANNOUNCEMENT_TITLES, MY_AUDITS, MY_WARS, READ_ANNOUNCEMENT, MARK_ALL_READ, BANK_ACCESS, VIEW_ANNOUNCEMENT, UNREAD_COUNT, LOCUTUS_TASKS, LOCUTUS_TASK, TABLE, CONFLICTALLIANCES, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, VIRTUALCONFLICTS, CONFLICTPOSTS, GLOBALSTATS, GLOBALTIERSTATS, COMPARETIERSTATS, COMPARESTATS, ALLIANCESTATS, STRENGTHTIERGRAPH, CITYTIERGRAPH, ALLIANCEMETRICAB, SPYTIERGRAPH, RADIATIONBYTURN, ALLIANCESDATABYDAY, SCORETIERGRAPH, COMPARESTOCKPILEVALUEBYDAY, METRIC_COMPARE_BY_TURN, ALLIANCEMETRICBYTURN, METRICBYGROUP, TRADEVOLUMEBYDAY, TRADEPRICEBYDAY, TRADEMARGINBYDAY, TRADETOTALBYDAY, ORBISSTATBYDAY, WARCOSTSBYDAY, MILITARIZATIONTIME, WARATTACKSBYDAY, WARSCOSTRANKINGBYDAY, NTHBEIGELOOTBYSCORERANGE, COMPARETIERDELTAGRAPH, TAX_EXPENSE, LIST_COALITIONS, LIST_ROLE_ALIASES, MULTI_V2, MULTI_BUSTER, CURRENT_TREATIES, TREATY_CHANGES];
