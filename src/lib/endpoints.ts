...
export const ENDPOINTS = [LOGOUT, LOGIN_MAIL, SET_TOKEN, SET_GUILD, SET_OAUTH_CODE, INPUT_OPTIONS, UNSET_GUILD, REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RECORDS, RAID, BALANCE, WITHDRAW, MY_WARS, MY_AUDITS, UNREAD_ANNOUNCEMENT, ANNOUNCEMENT_TITLES, MARK_ALL_READ, READ_ANNOUNCEMENT, VIEW_ANNOUNCEMENT, BANK_ACCESS, UNPROTECTED, UNREAD_COUNT, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, CONFLICTALLIANCES, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, CONFLICTPOSTS, VIRTUALCONFLICTS, GLOBALTIERSTATS, GLOBALSTATS, COMPARESTOCKPILEVALUEBYDAY, COMPARETIERDELTAGRAPH, NTHBEIGELOOTBYSCORERANGE, ALLIANCEMETRICBYTURN, METRIC_COMPARE_BY_TURN, WARSCOSTRANKINGBYDAY, METRICBYGROUP, COMPARETIERSTATS, COMPARESTATS, TRADEPRICEBYDAY, ALLIANCESDATABYDAY, MILITARIZATIONTIME, SPYTIERGRAPH, TRADEMARGINBYDAY, SCORETIERGRAPH, ALLIANCESTATS, WARATTACKSBYDAY, CITYTIERGRAPH, TRADEVOLUMEBYDAY, WARCOSTSBYDAY, ORBISSTATBYDAY, ALLIANCEMETRICAB, RADIATIONBYTURN, TRADETOTALBYDAY, STRENGTHTIERGRAPH, TAX_EXPENSE, MULTI_BUSTER, MULTI_V2, TREATY_CHANGES, CURRENT_TREATIES];
