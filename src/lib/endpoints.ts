...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, LOGIN_MAIL, SET_GUILD, SET_TOKEN, UNSET_GUILD, INPUT_OPTIONS, SET_OAUTH_CODE, TRADEPRICEBYDAYJSON, RECORDS, RAID, AUTOROLE, AUTOROLEALL, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, WITHDRAW, ANNOUNCEMENTS, BALANCE, UNPROTECTED, MY_AUDITS, MY_WARS, UNREAD_COUNT, BANK_ACCESS, MARK_ALL_READ, READ_ANNOUNCEMENT, VIEW_ANNOUNCEMENT, LOCUTUS_TASK, LOCUTUS_TASKS, TABLE, VIRTUALCONFLICTINFO, REMOVEVIRTUALCONFLICT, CONFLICTALLIANCES, VIRTUALCONFLICTS, CONFLICTPOSTS, GLOBALTIERSTATS, GLOBALSTATS, ALLIANCESTATS, COMPARESTATS, COMPARETIERSTATS, COMPARETIERDELTAGRAPH, CITYTIERGRAPH, STRENGTHTIERGRAPH, METRICBYGROUP, METRIC_COMPARE_BY_TURN, COMPARESTOCKPILEVALUEBYDAY, SCORETIERGRAPH, ALLIANCESDATABYDAY, RADIATIONBYTURN, ALLIANCEMETRICAB, SPYTIERGRAPH, ALLIANCEMETRICBYTURN, WARATTACKSBYDAY, NTHBEIGELOOTBYSCORERANGE, WARSCOSTRANKINGBYDAY, MILITARIZATIONTIME, ORBISSTATBYDAY, WARCOSTSBYDAY, TRADEVOLUMEBYDAY, TRADEPRICEBYDAY, TRADETOTALBYDAY, TRADEMARGINBYDAY, TAX_EXPENSE, LIST_COALITIONS, LIST_AUTOROLE_ROLES, REMOVE_ALLIANCE_ROLE, REMOVE_TAX_ROLE, ADD_ALLIANCE_ROLE, LIST_ROLE_ALIASES, ADD_CITY_ROLE, REMOVE_CITY_ROLE, ADD_TAX_ROLE, MULTI_BUSTER, MULTI_V2, CURRENT_TREATIES, TREATY_CHANGES];
