...
export const TAX_EXPENSE_BY_TIME: CommonEndpoint<ApiTypes.TaxExpenseTime, {datasetId?: string, start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}, {datasetId?: string, start?: string, end?: string, nationFilter?: string, dontRequireTagged?: string}> = {
    endpoint: new ApiEndpoint<ApiTypes.TaxExpenseTime>(
        "tax_expense_by_time",
        "tax_expense_by_time",
        {"datasetId":{"name":"datasetId","optional":true,"type":"Integer"},"start":{"name":"start","optional":true,"type":"Long[Timestamp]"},"end":{"name":"end","optional":true,"type":"Long[Timestamp]"},"nationFilter":{"name":"nationFilter","optional":true,"type":"Set\u003cDBNation\u003e"},"dontRequireTagged":{"name":"dontRequireTagged","optional":true,"flag":"t","type":"boolean"}},
...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, SET_TOKEN, SET_GUILD, LOGIN_MAIL, INPUT_OPTIONS, SET_OAUTH_CODE, UNSET_GUILD, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RECORDS, WITHDRAW, AUTOROLEALL, RAID, BALANCE, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, AUTOROLE, MY_AUDITS, MY_WARS, UNREAD_COUNT, BANK_ACCESS, MARK_ALL_READ, VIEW_ANNOUNCEMENT, READ_ANNOUNCEMENT, UNPROTECTED, LOCUTUS_TASKS, LOCUTUS_TASK, TABLE, CONFLICTALLIANCES, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, VIRTUALCONFLICTS, CONFLICTPOSTS, GLOBALTIERSTATS, GLOBALSTATS, COMPARETIERSTATS, COMPARESTATS, ALLIANCESTATS, COMPARESTOCKPILEVALUEBYDAY, METRIC_COMPARE_BY_TURN, WARSCOSTRANKINGBYDAY, COMPARETIERDELTAGRAPH, ALLIANCEMETRICBYTURN, NTHBEIGELOOTBYSCORERANGE, METRICBYGROUP, TRADEPRICEBYDAY, SPYTIERGRAPH, TRADETOTALBYDAY, SCORETIERGRAPH, CITYTIERGRAPH, WARATTACKSBYDAY, TRADEMARGINBYDAY, TRADEVOLUMEBYDAY, ALLIANCESDATABYDAY, ORBISSTATBYDAY, MILITARIZATIONTIME, ALLIANCEMETRICAB, WARCOSTSBYDAY, RADIATIONBYTURN, STRENGTHTIERGRAPH, TAX_EXPENSE_BY_TIME_RESOURCES, TAX_EXPENSE_BY_TIME_BRACKET, TAX_EXPENSE_BRACKET_ROWS, TAX_EXPENSE_BY_TIME, TAX_EXPENSE_NATION, TAX_EXPENSE, LIST_COALITIONS, REMOVE_ALLIANCE_ROLE, LIST_AUTOROLE_ROLES, REMOVE_TAX_ROLE, REMOVE_CITY_ROLE, ADD_ALLIANCE_ROLE, ADD_TAX_ROLE, LIST_ROLE_ALIASES, ADD_CITY_ROLE, MULTI_V2, MULTI_BUSTER, CURRENT_TREATIES, TREATY_CHANGES];
