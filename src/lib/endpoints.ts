...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, LOGIN_MAIL, SET_OAUTH_CODE, UNSET_GUILD, INPUT_OPTIONS, SET_GUILD, SET_TOKEN, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, RECORDS, BALANCE, WITHDRAW, RAID, UNREAD_ANNOUNCEMENT, ANNOUNCEMENT_TITLES, VIEW_ANNOUNCEMENT, MARK_ALL_READ, UNREAD_COUNT, BANK_ACCESS, READ_ANNOUNCEMENT, UNPROTECTED, MY_WARS, MY_AUDITS, LOCUTUS_TASKS, LOCUTUS_TASK, TABLE, CONFLICTALLIANCES, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, VIRTUALCONFLICTS, CONFLICTPOSTS, GLOBALSTATS, GLOBALTIERSTATS, WARSCOSTRANKINGBYDAY, NTHBEIGELOOTBYSCORERANGE, COMPARETIERDELTAGRAPH, METRIC_COMPARE_BY_TURN, ALLIANCEMETRICBYTURN, COMPARESTOCKPILEVALUEBYDAY, TRADEPRICEBYDAY, ALLIANCESDATABYDAY, MILITARIZATIONTIME, SPYTIERGRAPH, CITYTIERGRAPH, TRADETOTALBYDAY, ALLIANCEMETRICAB, STRENGTHTIERGRAPH, RADIATIONBYTURN, ORBISSTATBYDAY, WARCOSTSBYDAY, ALLIANCESTATS, TRADEVOLUMEBYDAY, WARATTACKSBYDAY, TRADEMARGINBYDAY, SCORETIERGRAPH, METRICBYGROUP, COMPARESTATS, COMPARETIERSTATS, TAX_EXPENSE, MULTI_BUSTER, MULTI_V2, TREATY_CHANGES, CURRENT_TREATIES];
