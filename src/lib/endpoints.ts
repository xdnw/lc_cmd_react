...
export const ENDPOINTS = [REGISTER, QUERY, SESSION, COMMAND, UNREGISTER, PERMISSION, LOGOUT, SET_TOKEN, SET_GUILD, SET_OAUTH_CODE, INPUT_OPTIONS, UNSET_GUILD, LOGIN_MAIL, TRADEPRICEBYDAYJSON, ANNOUNCEMENTS, WITHDRAW, RECORDS, RAID, BALANCE, AUTOROLEALL, VIEW_ANNOUNCEMENT, MARK_ALL_READ, READ_ANNOUNCEMENT, UNREAD_COUNT, BANK_ACCESS, UNPROTECTED, ANNOUNCEMENT_TITLES, UNREAD_ANNOUNCEMENT, MY_AUDITS, MY_WARS, AUTOROLE, LOCUTUS_TASKS, LOCUTUS_TASK, TABLE, CONFLICTALLIANCES, VIRTUALCONFLICTS, CONFLICTPOSTS, REMOVEVIRTUALCONFLICT, VIRTUALCONFLICTINFO, GLOBALTIERSTATS, GLOBALSTATS, COMPARESTATS, ALLIANCESTATS, COMPARETIERSTATS, TRADEPRICEBYDAY, ALLIANCESDATABYDAY, STRENGTHTIERGRAPH, MILITARIZATIONTIME, ALLIANCEMETRICAB, WARCOSTSBYDAY, CITYTIERGRAPH, TRADETOTALBYDAY, RADIATIONBYTURN, WARATTACKSBYDAY, SPYTIERGRAPH, SCORETIERGRAPH, TRADEVOLUMEBYDAY, ORBISSTATBYDAY, TRADEMARGINBYDAY, METRICBYGROUP, WARSCOSTRANKINGBYDAY, COMPARETIERDELTAGRAPH, ALLIANCEMETRICBYTURN, NTHBEIGELOOTBYSCORERANGE, COMPARESTOCKPILEVALUEBYDAY, METRIC_COMPARE_BY_TURN, TAX_EXPENSE, TAX_EXPENSE_NATION, TAX_EXPENSE_BY_TIME_RESOURCES, TAX_EXPENSE_BY_TIME_BRACKET, TAX_EXPENSE_BY_TIME, TAX_EXPENSE_BRACKET_ROWS, LIST_COALITIONS, LIST_AUTOROLE_ROLES, REMOVE_ALLIANCE_ROLE, ADD_CITY_ROLE, ADD_ALLIANCE_ROLE, REMOVE_CITY_ROLE, ADD_TAX_ROLE, LIST_ROLE_ALIASES, REMOVE_TAX_ROLE, MULTI_BUSTER, MULTI_V2, CURRENT_TREATIES, TREATY_CHANGES];
