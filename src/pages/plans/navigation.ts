...
const PLAN_ROUTE_GROUPS: readonly {
  ...
  },
  {
    ...
    title: "Member",
    items: [
      { id: "plans-deposits", title: "Deposits", path: "/plans/members/deposits", section: "Member", group: "Member", summary: "Member holdings and deposit breakdown." },
      { id: "plans-member-escrow", title: "Escrow", path: "/plans/members/escrow", section: "Member", group: "Member", summary: "Read-only blocked balance explanation." },
      { id: "plans-interviews", title: "Interviews", path: "/plans/members/interviews", section: "Member", group: "Member", summary: "Mentor queue and detail rail." },
      { id: "plans-recruitment", title: "Recruitment", path: "/plans/members/recruitment", section: "Member", group: "Member", summary: "Policy and outreach builder." },
      { id: "plans-audits", title: "Audits", path: "/plans/members/audits", section: "Member", group: "Member", summary: "Severity-grouped audit queue." },
      { id: "plans-coalitions", title: "Coalitions", path: "/plans/members/coalitions", section: "Member", group: "Member", summary: "Foreign-affairs directory and actions." },
      { id: "plans-treaties", title: "Treaties", path: "/plans/members/treaties", section: "Member", group: "Member", summary: "Treaty desk with relationship health." },
      { id: "plans-spheres", title: "Spheres", path: "/plans/members/spheres", section: "Member", group: "Member", summary: "Read-only analysis and comparisons." },
    ],
  },
  {
    id: "server",
  ...
  },
  {
    ...
    title: "Stats",
    items: [
      { id: "plans-kpi", title: "KPI", path: "/plans/reports/kpi", section: "Stats", group: "Stats", summary: "Layout builder with reusable cards and detail surfaces." },
      { id: "plans-tables", title: "Tables", path: "/plans/reports/tables", section: "Stats", group: "Stats", summary: "Curated table studio around saved views." },
      { id: "plans-graphs", title: "Graphs", path: "/plans/reports/graphs", section: "Stats", group: "Stats", summary: "Graph gallery with visible chart controls." },
      { id: "plans-rankings", title: "Rankings", path: "/plans/reports/rankings", section: "Stats", group: "Stats", summary: "Ranking explorer with trend context." },
      { id: "plans-conflicts", title: "Conflicts", path: "/plans/reports/conflicts", section: "Stats", group: "Stats", summary: "Conflict browser with staff mode." },
      { id: "plans-multi", title: "Multi Investigation", path: "/plans/reports/multi", section: "Stats", group: "Stats", summary: "Overlap investigation desk." },
    ],
  },
  {
    id: "commands",
